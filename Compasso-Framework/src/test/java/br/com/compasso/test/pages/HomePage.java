...
public class HomePage extends BasePage {
	...
	private String XPATH_PRIMEIRO_ITEM_RETORNADO_GLOBO = "//h3//span[contains(text(),'globo.com')]";
	private String XPATH_PRIMEIRO_ITEM_RETORNADO_UOL = "//h3//span[contains(text(),'UOL - O melhor conteúdo')]";
